...
@section('content')
    <div class="container mb-5">
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="patch" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="body" id="body">{{ old('title', $post->body) }}</textarea>
            </div>
